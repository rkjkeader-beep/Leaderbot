...
# ── Challenge IA désactivé — stubs de compatibilité ─────────────
def ai_scan_sym(sym, bias, bal): return None
def ai_full_scan(): return []
def ai_open(setup): return None
def ai_check(): pass
def chal_prog(c): return ""
